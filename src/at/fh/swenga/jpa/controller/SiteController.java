...
public class SiteController {
	...
	public String fill(Model model) {
		...
		PersonalCharacterModel personalCharacterModel2 = new PersonalCharacterModel("Ã„ngstlich");
		...
		// genders
		GenderModel genderMaleModel = new GenderModel("m", "MÃ¤nnlich");
		...
		UserModel userJane = new UserModel(genderFemaleModel, regionAndritzModel, "janedoe", "pa$$w0rd", "Jane", "Doe", "jane@doe.com", birthday2, "I also don't know what to write here.", "Hell", "Lang", "GrÃ¼n", "Schlank", 165, true, true, true, true, null);
